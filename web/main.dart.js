// Generated by dart2js, the Dart to JavaScript compiler version: 1.9.0-dev.8.0.
...
["_js_helper", "dart:_js_helper", , H, {
  ...
  thenHelper: function(object, helperCallback, completer, errorCallback) {
    var future, t1;
    ...
    t1 = H._wrapJsFunctionForThenHelper(helperCallback, completer);
    future.then$2$onError(t1, errorCallback == null ? null : H._wrapJsFunctionForThenHelper(errorCallback, completer));
    return completer.get$future();
  },
  _wrapJsFunctionForThenHelper: function($function, completer) {
    return new H._wrapJsFunctionForThenHelper_closure($function, completer);
  },
  ...
  _wrapJsFunctionForThenHelper_closure: {
    "^": "Closure:2;function_0,completer_1",
    call$1: function(result) {
      var e, st, exception, t1;
      try {
        this.function_0(result);
      } catch (exception) {
        t1 = H.unwrapException(exception);
        e = t1;
        st = new H._StackTrace(exception, null);
        this.completer_1.completeError$2(e, st);
      }
...
["dart.async", "dart:async", , P, {
  ...
  }, null, "call$2", "call$1", "_nullErrorHandler$closure", 2, 2, 17, 18],
  ...
  _Completer: {
    ...
    }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 19, 18]
  },
  _AsyncCompleter: {
    "^": "_Completer;future",
  ...
  _StreamIteratorImpl: {
    ...
    }, "_onError$1", "call$2", "call$1", "get$_onError", 2, 2, 19, 18],
    _onDone$0: [function() {
      if (this._state === 2) {
...
["dart.core", "dart:core", , P, {
  ...
  ArgumentError: {
    "^": "Error;_core$_hasValue,invalidValue,name,message",
    get$_errorName: function() {
      return "Invalid argument" + (this.name == null ? "(s)" : "");
    },
    ...
    toString$0: function(_) {
      ...
      errorValue = P.Error_safeToString(t1);
  ...
  RangeError: {
    "^": "ArgumentError;start,end,_core$_hasValue,invalidValue,name,message",
    get$_errorName: function() {
      return "RangeError";
    },
    get$_errorExplanation: function() {
  ...
  IndexError: {
    "^": "ArgumentError;indexable,length>,_core$_hasValue,invalidValue,name,message",
    get$_errorName: function() {
      return "RangeError";
    },
    get$_errorExplanation: function() {
...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var $goto = 0, completer = new P.Completer_Completer(), handler = null, $returnValue, req, audioContext, t1, gainNode, exception, audioBuffer, button, exception1;
        ...
        try {
          switch ($goto) {
            case 0:
              ...
              t1 = J.getInterceptor$x(audioContext);
              gainNode = t1.createGain$0(audioContext);
              req = null;
              handler = 2;
              P.print("requesting mp3");
              $goto = 5;
              return H.thenHelper(W.HttpRequest_request("ding.mp3", null, null, null, null, "arraybuffer", null, null), helper, completer, function(error) {
                $goto = 2;
                helper(error);
              });
            case 5:
            ...
            case 4:
              // after finally
              $goto = 6;
              return H.thenHelper(t1.decodeAudioData$1(audioContext, J.get$response$x(req)), helper, completer, null);
            case 6:
              // returning from await.
              audioBuffer = result;
              button = H.interceptedTypeCast(document.querySelector("#play"), "$isButtonElement");
              button.disabled = false;
              button.toString;
              t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(button, "click", false), [null]);
              H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.main_closure(audioContext, gainNode, audioBuffer)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
              t1 = J.get$onChange$x(document.querySelector("#volume"));
              H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.main_closure0(gainNode)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
            case 1:
              // return
              return H.thenHelper($returnValue, null, completer, null);
          }
        } catch (error) {
          if (handler === null)
            throw error;
    ...
    return H.thenHelper(null, helper, completer, null);
  }, "call$0", "main$closure", 0, 0, 0],
  main_closure: {
    "^": "Closure:2;audioContext_0,gainNode_1,audioBuffer_2",
    call$1: function(_) {
      var t1, source, t2;
      t1 = this.audioContext_0;
      source = t1.createBufferSource();
      source.buffer = this.audioBuffer_2;
      t2 = this.gainNode_1;
      source.connect(t2, 0, 0);
      t2.connect(t1.destination, 0, 0);
      if (!!source.start)
        source.start(0);
      else
        source.noteOn(0);
  ...
  main_closure0: {
    "^": "Closure:2;gainNode_3",
    call$1: function(e) {
      var t1, volume, max, fraction;
      t1 = J.getInterceptor$x(e);
      volume = H.Primitives_parseInt(J.get$value$x(t1.get$target(e)), null, null);
      max = H.Primitives_parseInt(J.get$max$x(t1.get$target(e)), null, null);
      if (typeof volume !== "number")
        return volume.$div();
      if (typeof max !== "number")
        return H.iae(max);
      fraction = volume / max;
      this.gainNode_3.gain.value = fraction * fraction;
    }
  }
},
1],
